...
export function createState(inParentComponent: React.Component) {
  ...
  return {
     ...
     *
     * @param inPID The player's ID.
     */
    handleMessage_connected : function(inPID: string): void {
     ...
     */
    handleMessage_start: function(inLayout: number[][][]): void {
     ...
     */
    handleMessage_update: function(inPID: string, inScore: number): void {
     ...
     */
    handleMessage_gameOver: function(inPID: string): void {
     ...
     */
    tileClick : function(inLayer: number, inRow: number, inColumn: number): void {
